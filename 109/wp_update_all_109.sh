...
#  USAGE
#  -----
#  Manual run : bash /root/Linux_Server_Public/109/wp_update_all_109.sh
#  Alias      : wpupdate
#  Cron       : 0 2 * * 3,6  bash /root/Linux_Server_Public/109/wp_update_all_109.sh >> /var/log/wp_update.log 2>&1
#
...
echo -e "$HR"
echo -e "${Y}              = Rooted by VladiMIR + AI | v.2026.05.07 | github.com/GinCz =${X}"
echo -e "$HR"
echo
