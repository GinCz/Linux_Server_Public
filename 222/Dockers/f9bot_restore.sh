...
#  USAGE
#  -----
#  bash /root/Linux_Server_Public/222/Dockers/f9bot_restore.sh
#  Alias: f9bot
#
# =============================================================================
...
# =============================================================================
echo -e "$HR"
echo -e "${C}   🔄 F9BOT — DOCKER RESTORE MENU — 222-DE-NetCup${X}"
...
if [ "$STRATEGY" = "commit" ]; then
    echo -e "  ${G}✔ VPN users/keys are PRESERVED inside the backup image.${X}"
fi
echo -e "$HR"
