...
#  USAGE
#  -----
#  Manual run : bash /root/Linux_Server_Public/222/wp_update_all_222.sh
#  Alias      : wpupdate
#  Cron       : 0 2 * * 3,6  bash /root/Linux_Server_Public/222/wp_update_all_222.sh >> /var/log/wp_update.log 2>&1
#
