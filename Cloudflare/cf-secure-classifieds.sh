#!/bin/bash
# ============================================================
# cf-secure-classifieds.sh
# Cloudflare security hardening for Classifieds / Doska sites
# FREE PLAN | Directorist, AWPCP, Advanced Classifieds, wpDiscuz
# No WooCommerce. Extra rule 25 for scanner/exploit blocking.
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " CF Security — Classifieds / Doska  |  Zone: $ZONE_ID"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
# ================================================================
echo ""
echo "🛡️  Rule 1/4: 20-Block-XMLRPC"
RES=$(upsert_rule \
    "20-Block-XMLRPC" \
...
# ================================================================
# RULE 25 — Block Scanners & sensitive paths (classifieds-specific)
# ================================================================
echo ""
echo "🛡️  Rule 2/4: 25-Block-Scanners"
SCANNER_EXPR='"(http.request.uri.path eq \"/my-account/\") or (http.request.uri.path eq \"/my-account\") or (http.request.uri.path contains \"/.env\") or (http.request.uri.path contains \"/.git\") or (http.request.uri.path contains \"/config.php\") or (http.request.uri.path contains \"/setup.php\") or (http.request.uri.path contains \"/install.php\") or (http.request.uri.path contains \"/wp-config\") or (http.request.uri.path contains \"/phpinfo\") or (http.request.uri.path contains \"/adminer\") or (http.request.uri.path contains \"/.htaccess\")"'
RES=$(upsert_rule "25-Block-Scanners" "$SCANNER_EXPR" "block")
check "$RES"
...
# ================================================================
echo ""
echo "🛡️  Rule 3/4: 30-Challenge-WP-Admin+Login"
RES=$(upsert_rule \
...
# ================================================================
# RULE 40 — Rate Limiting (Free plan: period=10, timeout=10)
# ================================================================
echo ""
echo "🛡️  Rule 4/4: 40-RateLimit-Bots (50 req/10s)"
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " ✅ Done! 4 rules applied for Classifieds/Doska site."
