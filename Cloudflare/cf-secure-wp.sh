...
# ============================================================
# cf-secure-wp.sh
# Cloudflare security hardening for WordPress (no WooCommerce)
# FREE PLAN | 3 rules: XMLRPC block + WP-Admin challenge + RateLimit
# = Rooted by VladiMIR + AI | v.2026.06.03 | github.com/GinCz =
# ============================================================
# USAGE:
#   export CF_TOKEN="your_api_token"
#   export ZONE_ID="your_zone_id"
#   bash cf-secure-wp.sh
# ============================================================
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " CF Security — WordPress (no WooCommerce)  |  Zone: $ZONE_ID"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
# ---- Upsert a custom rule (remove old by description, append new) ----
upsert_rule() {
    local DESC="$1" EXPR="$2" ACTION="$3"
    local RID=$(get_ruleset_id)

    if [[ -z "$RID" ]]; then
        # No ruleset yet — create with this rule
    ...
    # Get existing rules, remove old version of this rule
...
# ================================================================
echo ""
echo "🛡️  Rule 3/3: 40-RateLimit-Bots (50 req/10s)"
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " ✅ Done! CF Dashboard → domain → Security → Security rules"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
