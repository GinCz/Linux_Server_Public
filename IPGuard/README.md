...
```
https://raw.githubusercontent.com/GinCz/Linux_Server_Public/main/IPGuard/blacklist.txt
```
*(Legacy mirror: `https://raw.githubusercontent.com/GinCz/Linux_Server_Public/main/blacklist/blacklist.txt`)*

**► Full database — CSV with reason, source server, date, duration:**
```
https://raw.githubusercontent.com/GinCz/Linux_Server_Public/main/IPGuard/blacklist-full.csv
```
*(Legacy mirror: `https://raw.githubusercontent.com/GinCz/Linux_Server_Public/main/blacklist/blacklist-full.csv`)*
