...
- `04_general_scripts` — Universal scripts running across all servers (domain checks, resource allocation, etc.).
- `docs` — Security rules, WAF setups, and server architecture documentation.

## Guidelines
- **Clear Screen**: Every script must start with the `clear` command.
