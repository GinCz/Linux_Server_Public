...
HR="\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550"
echo -e "${YL}  ${HR}\n   AmneziaWG Stats v2026-04-13k  |  $(hostname)  |  $(date '+%Y-%m-%d %H:%M:%S')\n  ${HR}${X}\n"
TABLE=$(docker exec amnezia-awg cat /opt/amnezia/awg/clientsTable 2>/dev/null)
[[ -z "$TABLE" ]] && echo -e "${RD}  ERROR: clientsTable empty. Run: docker ps | grep amnezia${X}" && exit 1
...
function fmtT(g){if(g==0)return "-";if(g>=1)return sprintf("%.1f GiB",g);if(g*1024>=1)return sprintf("%.1f MiB",g*1024);return sprintf("%.1f KiB",g*1024*1024)}
{
  ...
  ipc=(ip=="N/A")?RD:WH
  printf "  %s%-15s%s  %s%-28s%s  %s%-20s%s  %s%-11s%s  %s%-11s%s  %s%-9s%s\n",ipc,ip,X,YL,name,X,hsc,hs,X,GN,fmt(rxg),X,CY,fmt(txg),X,OR,fmtT(tot),X
  trx+=rxg;ttx+=txg
}
END{
