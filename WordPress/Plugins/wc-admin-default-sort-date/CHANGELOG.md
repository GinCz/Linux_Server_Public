# CHANGELOG - WooCommerce Admin Products Default Sort by Date DESC
...
- Unified update mechanism with GitHub API updater: Update URI: https://vladimir-ai.updates/wc-admin-default-sort-date + ladimir-ai-updater.php.
