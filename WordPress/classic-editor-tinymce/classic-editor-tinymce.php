...
add_filter( 'plugin_action_links_' . plugin_basename( __FILE__ ), function( $links ) {
    ...
    $docs_link     = '<a href="https://github.com/GinCz/Linux_Server_Public/tree/main/WordPress/classic-editor-tinymce" target="_blank" style="white-space:nowrap;">' . esc_html( $docs_label ) . '</a>';
