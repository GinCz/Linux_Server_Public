 ...
 * Plugin URI:  https://github.com/GinCz/Secret_Privat/tree/main/WordPress/disable-update-emails
...
add_filter( 'plugin_action_links_' . plugin_basename( __FILE__ ), function( $links ) {
    ...
    $docs_link     = '<a href="https://github.com/GinCz/Secret_Privat/tree/main/WordPress/disable-update-emails" target="_blank" style="white-space:nowrap;">' . esc_html( $docs_label ) . '</a>';
...
function vladimir_due_render_settings_page() {
    ...
    <div class="wrap" style="max-width:850px;">
        ...
        <p style="margin-top:15px;color:#64748b;font-size:12px;">
            ...
            <a href="https://github.com/GinCz/Secret_Privat/tree/main/WordPress/disable-update-emails" target="_blank" style="text-decoration:none;">GitHub Docs ↗</a>
        </p>
    </div>
    <?php
}
