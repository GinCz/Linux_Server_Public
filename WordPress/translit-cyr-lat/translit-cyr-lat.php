...
add_filter( 'all_plugins', function( $plugins ) {
    ...
    if ( isset( $plugins[ $plugin_key ] ) ) {
        ...
        if ( 'ru' === $lang ) {
            $plugins[ $plugin_key ]['Name']        = 'Транслитерация Кириллицы и Чешских букв в Латиницу SEO (VladiMIR+AI)';
            ...
            $plugins[ $plugin_key ]['Name']        = 'Transliterace azbuky a češtiny do latinky SEO (VladiMIR+AI)';
