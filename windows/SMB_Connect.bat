...
start /b cmd /c "ping -n 1 -w 1500 91.84.118.178 >nul 2>&1 && (net use N: /delete /yes >nul 2>&1 & net use N: \\91.84.118.178\storage /persistent:yes >nul 2>&1 && type nul>C:\smbtmp\ok\N.txt || type nul>C:\smbtmp\fail\N.txt) || type nul>C:\smbtmp\skip\N.txt"
...
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\MountPoints2\##91.84.118.178#storage"    /v _LabelFromReg /t REG_SZ /d "PILIK_178"  /f >nul 2>&1
